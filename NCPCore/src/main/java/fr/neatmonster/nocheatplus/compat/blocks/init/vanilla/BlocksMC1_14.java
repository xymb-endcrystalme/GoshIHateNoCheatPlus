...
public class BlocksMC1_14 implements BlockPropertiesSetup{
	...
	public void setupBlockProperties(WorldConfigProvider<?> worldConfigProvider) {
		...
		BlockFlags.addFlags("BAMBOO", BlockFlags.F_GROUND | BlockFlags.F_GROUND_HEIGHT | BlockFlags.F_VARIABLE);
		...
		BlockFlags.addFlags("GRINDSTONE", BlockFlags.SOLID_GROUND | BlockFlags.F_GROUND_HEIGHT);
