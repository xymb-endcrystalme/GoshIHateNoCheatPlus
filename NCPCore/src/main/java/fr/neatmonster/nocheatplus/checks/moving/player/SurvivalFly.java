...
public class SurvivalFly extends Check {
    ...
    */
     ...
     * @param cc
     */
    private void setPreHorCheckingData(final PlayerMoveData thisMove, final PlayerLocation from, final PlayerLocation to, final MovingData data, 
            ...
            if (yDistance > 0.0) {
                ...
                if (!data.sfLowJump && !data.sfNoLowJump && data.liftOffEnvelope == LiftOffEnvelope.NORMAL
                    ...
                    if (setBackYDistance > 0.0 && setBackYDistance < estimate) {
                        ...
                        if (slope || thisMove.headObstructed || yDistance <= 0.0 && lastMove.headObstructed && lastMove.yDistance >= 0.0
